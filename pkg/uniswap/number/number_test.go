	...
	tests := []struct {
	...
	}{
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(1), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(4), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(7), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(4), WithRoundingMode(RoundHalfUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(3), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(7), WithRoundingMode(RoundDown)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(1), WithRoundingMode(RoundDown)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(6), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(5), WithRoundingMode(RoundDown)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(8), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(2), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(9), WithRoundingMode(RoundHalfUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(4), WithRoundingMode(RoundDown)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(7), WithRoundingMode(RoundHalfUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(0), WithRoundingMode(RoundHalfUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(3), WithRoundingMode(RoundHalfUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(8), WithRoundingMode(RoundDown)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(0), WithRoundingMode(RoundDown)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(5), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(5), WithRoundingMode(RoundHalfUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(2), WithRoundingMode(RoundHalfUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(2), WithRoundingMode(RoundDown)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(8), WithRoundingMode(RoundHalfUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(1), WithRoundingMode(RoundHalfUp)),
			},
			want: mustNewFromString("0"),
		},
		{
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(34), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(53), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(27), WithRoundingMode(RoundHalfUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(44), WithRoundingMode(RoundHalfUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(21), WithRoundingMode(RoundHalfUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(46), WithRoundingMode(RoundDown)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(15), WithRoundingMode(RoundHalfUp)),
			},
			want: mustNewFromString("0"),
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(59), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(17), WithRoundingMode(RoundDown)),
			},
			want: mustNewFromString("0"),
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(42), WithRoundingMode(RoundHalfUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(51), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(40), WithRoundingMode(RoundDown)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(59), WithRoundingMode(RoundHalfUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(48), WithRoundingMode(RoundHalfUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(24), WithRoundingMode(RoundHalfUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(21), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(0), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(30), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(58), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(25), WithRoundingMode(RoundDown)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(41), WithRoundingMode(RoundDown)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(50), WithRoundingMode(RoundHalfUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(52), WithRoundingMode(RoundDown)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(46), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(34), WithRoundingMode(RoundHalfUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(16), WithRoundingMode(RoundDown)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(16), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(58), WithRoundingMode(RoundDown)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(57), WithRoundingMode(RoundHalfUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(33), WithRoundingMode(RoundDown)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(31), WithRoundingMode(RoundDown)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(44), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(10), WithRoundingMode(RoundDown)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(16), WithRoundingMode(RoundHalfUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(45), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(50), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(26), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(9), WithRoundingMode(RoundDown)),
			},
			want: mustNewFromString("0"),
		},
		{
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(51), WithRoundingMode(RoundDown)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(33), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(42), WithRoundingMode(RoundDown)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(11), WithRoundingMode(RoundHalfUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(21), WithRoundingMode(RoundDown)),
			},
			want: mustNewFromString("0"),
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(20), WithRoundingMode(RoundHalfUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(36), WithRoundingMode(RoundHalfUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(14), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(43), WithRoundingMode(RoundHalfUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(42), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(12), WithRoundingMode(RoundDown)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(27), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(17), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(10), WithRoundingMode(RoundUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(35), WithRoundingMode(RoundHalfUp)),
			},
		...
		},
		{
			args: args{
				...
				opts: New(WithRoundingPrecision(31), WithRoundingMode(RoundUp)),
			},

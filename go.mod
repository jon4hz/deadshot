module github.com/jon4hz/deadshot
...
require (
	...
	github.com/thomas-tacquet/gormv2-logrus v1.1.1
...
replace github.com/charmbracelet/bubbletea => github.com/jon4hz/bubbletea v0.19.3
